 ...
 */
public abstract class Hilt_RecipeDetailFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecipeDetailFragment_GeneratedInjector) this.generatedComponent()).injectRecipeDetailFragment(UnsafeCasts.<RecipeDetailFragment>unsafeCast(this));
    }
  }
