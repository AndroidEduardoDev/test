 ...
 */
public abstract class Hilt_RecipeMapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecipeMapFragment() {
    super();
  }

  Hilt_RecipeMapFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecipeMapFragment_GeneratedInjector) this.generatedComponent()).injectRecipeMapFragment(UnsafeCasts.<RecipeMapFragment>unsafeCast(this));
    }
  }
