 ...
 */
public abstract class Hilt_RecipeFilterFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecipeFilterFragment_GeneratedInjector) this.generatedComponent()).injectRecipeFilterFragment(UnsafeCasts.<RecipeFilterFragment>unsafeCast(this));
    }
  }
